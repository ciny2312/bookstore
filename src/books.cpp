...
void books::change_name(String _name) {
  files<book_name,book_name_block,book_name_summary>f_name("book_name");
  if(name!=String()){
...
void books::change_author(String _author) {
  files<book_author,book_author_block,book_author_summary>f_name("book_author");
  if(author!=String()){
...
void books::change_key(String *_keys, int _num) {
  for (int i = 1; i <= k_num; i++) {
    files<book_key, book_key_block, book_key_summary> f_name("book_key");
